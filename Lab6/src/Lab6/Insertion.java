...
public class Insertion {
    ...
    /*
     * Add a version of the sort method that takes an array of integers 
     * This version of the sort method will sort int values
     * The return type of the method will be void
     */
    ...
    ***************************************************************************/
    ...
    private static boolean isSorted(int[] generateIntValues) {
        return isSorted(generateIntValues, 0, generateIntValues.length);
    }
    ...
    private static boolean isSorted(int[] generateIntValues, int lo, int hi) {
        for (int i = lo + 1; i < hi; i++)
            if (less(generateIntValues[i], generateIntValues[i-1])) return false;
        return true;
    }
